...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('NEW', 'RESERVED', 'PAID', 'READY_FOR_COLLECTION', 'COLLECTED', 'SHIPPED', 'CANCELLED', 'REFUNDED');

-- AlterTable
ALTER TABLE "Product" ADD COLUMN     "stockLocationId" TEXT;
...
CREATE TABLE "Order" (
    ...
    "fulfillment" TEXT NOT NULL DEFAULT 'COLLECT',
